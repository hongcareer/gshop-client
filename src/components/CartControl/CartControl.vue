<template>
  <div class="cartcontrol">
    <transition name="add">
      <div class="iconfont icon-remove_circle_outline" @click.stop="changeFoodCount(false)" v-if="food.count>0"></div>
    </transition>
  ...
  export default {
    ...
    methods:{
      changeFoodCount(isAdd){
        this.$store.dispatch('getFoodCount',{food:this.food,isAdd})
      }
    }
